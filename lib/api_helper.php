 ...
 * @param string $method The HTTP method to use of the request.
 * @param bool $isRapidAPI Whether or not the request is for RapidAPI.
...
*/
function _sendRequest($url, $key, $data=[], $method='GET', $isRapidAPI=true, $rapidAPIHost="newsdata2.p.rapidapi.com")
{
    global $API_KEYS;
